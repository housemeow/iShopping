app.factory('DBManager', function($window, PhoneGap) {
    ...
    PhoneGap.ready(function() {
        ...
        db.transaction(function(tx) {
            tx.executeSql("CREATE TABLE IF NOT EXISTS friends(id INTEGER PRIMARY KEY ASC, name TEXT UNIQUE, phone TEXT UNIQUE, email TEXT, birthday DATE, isMember BOOLEAN)", []);
