...
app.config(function($stateProvider, $urlRouterProvider) {
	$stateProvider
	    .state('tab', {
	        url: "/tab",
	        abstract: true,
	        templateUrl: "templates/09_publish/tab.html"
	    })
        .state('tab.friends', {
            url: '/friends',
            views: {
                'tab-friends': {
                    templateUrl: 'templates/09_publish/friends.html',
        ...
        .state('tab.setting', {
            ...
            views: {
                'tab-setting': {
                    templateUrl: 'templates/09_publish/setting.html',
		...
		.state('tab.members', {
	        ...
	        views: {
	            'tab-members': {
	                templateUrl: 'templates/09_publish/members.html',
	    ...
	    .state('tab.publish', {
	        ...
	        views: {
                'tab-publish': {
                    templateUrl: 'templates/09_publish/publish.html',
	    ...
	    .state('chat', {
	        url: '/chat/:phone',
            templateUrl: 'templates/09_publish/chat.html',
            controller: 'ChatCtrl'
	    });
...
app.run(function(DBManager, SettingManager, PushNotificationsFactory, iLabMessage, $window, PhoneGap, $rootScope, FriendManager, ChatManager) {
	...
	$window.receiveMessage = function(payload) {
		...
		if (friend || host.publisherId == message.senderPhone) {
